...
export default function App() {
  ...
  return <div className="app-shell">
    ...
    {(connection === 'offline' || connection === 'error' || connection === 'polling') && <div className="connection-banner" role="status"><WifiOff size={14}/>{connection === 'offline' ? 'Offline · Showing last known prices' : connection === 'polling' ? 'Fallback updates every 5 seconds' : 'Prices may be outdated · Reconnecting'}</div>}
